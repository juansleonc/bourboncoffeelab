...
(function($){"use strict";$(document).ready(function(){const container=document.querySelector('.site-location');const button=document.querySelectorAll('.select-location');const close=document.querySelector('.site-location .site-location-close');if(container!==null&&button!==null){for(var i=0;i<button.length;i++){button[i].addEventListener('click',(e)=>{e.preventDefault();container.classList.add('active')},!1)}
close.addEventListener('click',(e)=>{e.preventDefault();container.classList.remove('active')},!1);$('.site-location ul li a').on('click',function(e){$.cookie("location",$(this).data('value'));location.reload(!0)});$('.site-location').on('click',function(e){e.preventDefault();container.classList.remove('active')})}})})(jQuery);
...
jQuery(window).on('elementor/frontend/init',function(){elementorFrontend.hooks.addAction('frontend/element_ready/furnob-home-slider.default',klb_carousel);elementorFrontend.hooks.addAction('frontend/element_ready/furnob-banner-slider.default',klb_carousel);elementorFrontend.hooks.addAction('frontend/element_ready/furnob-product-categories.default',klb_carousel);elementorFrontend.hooks.addAction('frontend/element_ready/furnob-product-carousel.default',klb_carousel);elementorFrontend.hooks.addAction('frontend/element_ready/furnob-counter-box.default',klb_counter);elementorFrontend.hooks.addAction('frontend/element_ready/furnob-counter-box2.default',klb_counter);elementorFrontend.hooks.addAction('frontend/element_ready/furnob-banner-carousel.default',klb_carousel);elementorFrontend.hooks.addAction('frontend/element_ready/furnob-client-carousel.default',klb_carousel);elementorFrontend.hooks.addAction('frontend/element_ready/furnob-testimonial-carousel.default',klb_carousel)})})(jQuery);