...
;
(function($){"use strict";$(document).on('furnobShopPageInit',function(){furnobThemeModule.stickysidebar()});furnobThemeModule.stickysidebar=function(){const sticky=document.querySelectorAll('.sticky');if(sticky!==null){for(var i=0;i<sticky.length;i++){const self=sticky;$(self).theiaStickySidebar({additionalMarginTop:30})}}}
$(document).ready(function(){furnobThemeModule.stickysidebar()})})(jQuery);
(function($){"use strict";$(document).on('furnobShopPageInit',function(){furnobThemeModule.sidebarfilter()});furnobThemeModule.sidebarfilter=function(){var sidebar=$('.filtered-sidebar');var button=$('.filter-button');var siteOverlay=$('.site-mask');var close=$('.close-sidebar');var tl=gsap.timeline({paused:!0,reversed:!0});tl.set(sidebar,{autoAlpha:1}).to(sidebar,.5,{x:0,ease:'power4.inOut'}).to(siteOverlay,.5,{autoAlpha:1,ease:'power4.inOut'},"-=.5");button.on('click',function(e){e.preventDefault();siteOverlay.addClass('active');tl.reversed()?tl.play():tl.reverse()});close.on('click',function(e){e.preventDefault();tl.reverse();setTimeout(function(){siteOverlay.removeClass('active')},1000)});$('.site-mask').on('click',function(e){e.preventDefault();tl.reverse();setTimeout(function(){$('.site-mask').removeClass('active')},1000)})}
$(document).ready(function(){furnobThemeModule.sidebarfilter()})})(jQuery);
(function($){"use strict";$(document).on('furnobShopPageInit',function(){furnobThemeModule.sitescroll()});furnobThemeModule.sitescroll=function(){const container=document.querySelectorAll('.site-scroll');for(var i=0;i<container.length;i++){const ps=new PerfectScrollbar(container[i],{suppressScrollX:!0,wheelPropagation:!0});ps.update()}}
$(document).ready(function(){furnobThemeModule.sitescroll()})})(jQuery);
(function($){"use strict";$(document).on('furnobShopPageInit',function(){furnobThemeModule.siteslider()});furnobThemeModule.siteslider=function(){const slider=document.querySelectorAll('.site-slider');if(slider!==null){for(var i=0;i<slider.length;i++){const self=slider[i];const desktop=parseInt(self.dataset.desktop);const tablet=parseInt(self.dataset.tablet);const mobile=parseInt(self.dataset.mobile);const speed=parseInt(self.dataset.speed);const loop=self.dataset.loop==='true'?!0:!1;const gutter=parseInt(self.dataset.gutter);const autoplay=self.dataset.autoplay==='true'?!0:!1;const autospeed=parseInt(self.dataset.autospeed);const autostop=self.dataset.autostop==='true'?!0:!1;const nav=self.dataset.nav==='true'?!0:!1;const dots=self.dataset.dots==='true'?!0:!1;const dotsData=self.dataset.dotsdata==='true'?!0:!1;$(self).owlCarousel({loop:loop,dots:dots,dotsData:dotsData,nav:nav,smartSpeed:speed,margin:gutter,responsiveClass:!0,autoplay:autoplay,autoplayTimeout:autospeed,navText:['<i class="klbth-icon-left-open-big"></i>','<i class="klbth-icon-right-open-big"></i>'],responsive:{0:{items:mobile,nav:!1},480:{items:mobile,nav:!1},768:{items:tablet},1024:{items:tablet},1200:{items:desktop}}});if(nav===!0){const images=self.querySelectorAll('img');imagesLoaded(images,()=>{self.classList.add('images-loaded');for(var i=0;i<images.length;i++){const img=images[i];const imageHeight=img.clientHeight;const prevButton=self.querySelector('.owl-prev');const nextButton=self.querySelector('.owl-next');prevButton.style.top=`${imageHeight / 2 - 12}px`;nextButton.style.top=`${imageHeight / 2 - 12}px`}})}}}}
$(document).ready(function(){furnobThemeModule.siteslider()})})(jQuery);
(function($){"use strict";const FURNOB_APP={init(){this.dom();this.cartSide();this.searcHolder();this.mobileMenu();this.siteCountdown();this.siteTooltip();this.themeQuantity();this.gdprCookie();this.mobileBottomMenu()},dom(){this.overlay=document.querySelector('.site-mask')},cartSide(){const button=document.querySelectorAll('.cart-button');if(button!==null){for(var i=0;i<button.length;i++){const self=button[i];const cartSide=document.querySelector('.cart-widget-side');const close=cartSide.querySelector('.cart-side-close');const tl=gsap.timeline({paused:!0,reversed:!0});tl.to(this.overlay,{duration:.2,autoAlpha:1});tl.to(cartSide,{duration:.4,ease:'power3.inOut',x:0},"-=.3");self.addEventListener('click',(e)=>{e.preventDefault();tl.play()});close.addEventListener('click',(e)=>{e.preventDefault();tl.reverse()});$('.site-mask').on('click',function(e){e.preventDefault();tl.reverse();setTimeout(function(){$('.site-mask').removeClass('active')},1000)})}}},searcHolder(){const container=document.querySelector('.search-holder');if(container!==null){const button=document.querySelectorAll('.search-button');const close=document.querySelector('.search-holder-close');const focusInput=()=>{if(window.innerWidth>1024){document.querySelector('.search-holder .search-form input').focus()}}
const search=gsap.timeline({paused:!0,reversed:!0});let forward=!0;search.to(this.overlay,{duration:.2,autoAlpha:1});search.to(container,{duration:.4,y:0,ease:'power2.inOut'});search.to('.search-holder .search-item',{duration:.4,ease:'ease.inOut',y:0,opacity:1,stagger:.1,onComplete:focusInput},"-=.2");if(forward){if(button!==null){for(var i=0;i<button.length;i++){button[i].addEventListener('click',(e)=>{e.preventDefault();search.play();forward=!1},!1)}}}
close.addEventListener('click',(e)=>{e.preventDefault();if(!forward){search.reverse(1.5)}
forward=!0},!1);this.overlay.addEventListener('click',(e)=>{e.preventDefault();if(!forward){search.reverse(1.5)}
forward=!0},!1);document.addEventListener('keyup',(ev)=>{if(ev.keyCode==27){if(!forward){search.reverse(1.5)}
forward=!0}})}},mobileMenu(){const canvasMenu=document.querySelector('.site-offcanvas');if(canvasMenu!=null||this.overlay!==null){let tl=gsap.timeline({paused:!0,reversed:!0});tl.set(canvasMenu,{autoAlpha:1}).to(canvasMenu,.5,{x:0,ease:'power4.inOut'}).to(this.overlay,.5,{autoAlpha:1,ease:'power4.inOut'},"-=.5");const button=document.querySelectorAll('.toggle-menu');const categoryButton=$('.mobile-bottom-menu a.categories');const close=document.querySelector('.offcanvas-close');if(button!==null){for(var i=0;i<button.length;i++){const self=button[i];self.addEventListener('click',(e)=>{e.preventDefault();tl.play()})}}
...
close.addEventListener('click',(e)=>{e.preventDefault();tl.reverse(1.5)});$('.site-mask').on('click',function(e){e.preventDefault();tl.reverse();setTimeout(function(){$('.site-mask').removeClass('active')},1000)});const hasChildren=document.querySelectorAll('.site-offcanvas .menu-item-has-children');const subMenu=(e)=>{let subUl;if(e.target.tagName==='A'){e.preventDefault();subUl=e.target.nextElementSibling}else{subUl=e.target.previousElementSibling}
...
const slider=document.querySelectorAll('.site-slider');if(slider!==null){for(var i=0;i<slider.length;i++){const self=slider[i];const desktop=parseInt(self.dataset.desktop);const tablet=parseInt(self.dataset.tablet);const mobile=parseInt(self.dataset.mobile);const speed=parseInt(self.dataset.speed);const loop=self.dataset.loop==='true'?!0:!1;const gutter=parseInt(self.dataset.gutter);const autoplay=self.dataset.autoplay==='true'?!0:!1;const autospeed=parseInt(self.dataset.autospeed);const autostop=self.dataset.autostop==='true'?!0:!1;const nav=self.dataset.nav==='true'?!0:!1;const dots=self.dataset.dots==='true'?!0:!1;const dotsData=self.dataset.dotsdata==='true'?!0:!1;$(self).owlCarousel({loop:loop,dots:dots,dotsData:dotsData,nav:nav,smartSpeed:speed,margin:gutter,responsiveClass:!0,autoplay:autoplay,autoplayTimeout:autospeed,autoplayHoverPause:autostop,navText:['<i class="klbth-icon-left-open-big"></i>','<i class="klbth-icon-right-open-big"></i>'],responsive:{0:{items:mobile,nav:!1},480:{items:mobile,nav:!1},768:{items:tablet},1024:{items:tablet},1200:{items:desktop}}});if(nav===!0){const images=self.querySelectorAll('img');imagesLoaded(images,()=>{self.classList.add('images-loaded');for(var i=0;i<images.length;i++){const img=images[i];const imageHeight=img.clientHeight;const prevButton=self.querySelector('.owl-prev');const nextButton=self.querySelector('.owl-next');prevButton.style.top=`${imageHeight / 2 - 12}px`;nextButton.style.top=`${imageHeight / 2 - 12}px`}})}}}
...
(function($){furnobThemeModule.ajaxLinks='.widget_klb_product_categories a, .widget_product_status a, .remove-filter a, .widget_layered_nav a, .product-views-buttons a, .woocommerce-pagination a';furnobThemeModule.ajaxFilters=function(){furnobThemeModule.$document.pjax(furnobThemeModule.ajaxLinks,'.site-content',{timeout:5000,scrollTo:!1,renderCallback:function(context,html,afterRender){context.html(html);afterRender()}});furnobThemeModule.$document.on('submit','.widget_price_filter form',function(event){$.pjax.submit(event,'.site-content');furnobThemeModule.$document.trigger('furnobShopPageInit')});furnobThemeModule.$document.on('pjax:error',function(xhr,textStatus,error){console.log('pjax error '+error)});furnobThemeModule.$document.on('pjax:start',function(){scrollToTop(!1);var $siteContent=$('.site-content');$siteContent.removeClass('ajax-loaded');$siteContent.addClass('ajax-loading');$(".site-primary .content-primary .products, nav.woocommerce-pagination").hide();$('.site-primary .content-primary .products').before('<svg class="loader-image preloader" width="65px" height="65px" viewBox="0 0 66 66" xmlns="http://www.w3.org/2000/svg"><circle class="path" fill="none" stroke-width="6" stroke-linecap="round" cx="33" cy="33" r="30"></circle></svg></div>')});furnobThemeModule.$document.on('pjax:complete',function(){$('.site-content').removeClass('ajax-loading');$('.loader-image.preloader').remove();furnobThemeModule.$document.trigger('furnobShopPageInit');$('.site-mask').removeClass('active');$(".site-mask").css({"opacity":"0","visibility":"hidden"})});furnobThemeModule.$document.on('pjax:end',function(){scrollToTop(!1);var $siteContent=$('.site-content');$siteContent.removeClass('ajax-loading');$siteContent.addClass('ajax-loaded')});var scrollToTop=function(type){if(furnob_settings.ajax_scroll==='no'&&type===!1){return!1}
var $scrollTo=$(furnob_settings.ajax_scroll_class),scrollTo=$scrollTo.offset().top-furnob_settings.ajax_scroll_offset;$('html, body').stop().animate({scrollTop:scrollTo},400)}};$(document).ready(function(){furnobThemeModule.ajaxFilters()})})(jQuery);
...
(function(){'use strict';if(typeof wc_facebook_pixel_data==='undefined'){return}
var data=wc_facebook_pixel_data;var firedEvents={};function buildEventData(event){return{method:event.method||'track',name:event.name,params:event.params||{},eventId:event.eventId||null}}
...
if(typeof fbq!=='function'){logWarning('fbq not available, skipping event:',eventData.name);return}
try{var params=eventData.params;if(eventData.eventId){fbq(eventData.method,eventData.name,params,{eventID:eventData.eventId})}else{fbq(eventData.method,eventData.name,params)}
...
data.eventQueue=[]}
function init(){if(document.readyState==='complete'){fireQueuedEvents()}else{window.addEventListener('load',fireQueuedEvents)}}
init()})();